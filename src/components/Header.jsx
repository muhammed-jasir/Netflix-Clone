...
const Header = () => {
    ...
    return (
        <header className={`relative w-full flex gap-10 justify-between items-center px-5 py-5 z-10 bg-gradient-to-b from-black/70 via-black/70 to-transparent ${navbarToggle ? 'mb-[258px]' : 'mb-0'} md:mb-0`}>
